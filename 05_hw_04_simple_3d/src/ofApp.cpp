/* Example from 'Mastering openFrameworks', Chapter 3 */
...
void ofApp::setup(){
    ...
    for (int i=0; i<nTri; i++) {
        ...
        // as the center plus random point from //[-rad, rad]x[-rad, rad]x[-rad, rad]
        for (int j=0; j<3; j++) {
    ...
    colors.resize( nTri );
    for (int i=0; i<nTri; i++) { //Take a random color from black to red
