...
void ofApp::setup(){
    ...
    Rad = 25; //Radius of circle
    circleStep = 3;	//Step size for circle motion
    circleN = 40; //Number of points on the circle
...
void ofApp::addRandomCircle( ofMesh &mesh ){
    ...
    //Parameters Ð twisting and rotating angles and color
    float twistAngle = 5.0 * ofSignedNoise( time * 0.3 + 332.4 );
    float rotateAngle = 1.5;
//    float rotateAngle = 5.0 * ofSignedNoise( time * 0.3 + 100 );
